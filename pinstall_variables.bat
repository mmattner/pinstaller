...
SET DOFLINX_CONFIG=%DOF_CONFIG_DIR%DOFLinx.ini
SET PINUP_CONFIG_DIR=%DIRBASE%PinupSystem\
SET TEMP_DIR=Temp\
...
REM DOF Installation locations
SET INSTALL_FUTUREPINBALL_LOC=%INSTALLBASE_LOC%Games\Future Pinball\
...
SET INSTALL_PINUP_PUPMEDIA_LOC=%INSTALL_PINUP_LOC%POPMedia\
